...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    <h1 class="w3-jumbo"><b>The Watch Factory</b></h1>
  ...
  <?php
   $res = $conn->query("SELECT * FROM images where cid=3");
   $numr=$res->num_rows;
   if ($res->num_rows > 0) {
  ...
  <div class="w3-container" id="services" style="margin-top:75px">
    ...
    <hr style="width:50px;border:5px solid #f2e6ff" class="w3-round">
    <p>The Watch Factory sells quality watches and provides excellent customer service for customers seeking a reliable watch.
         In the future The Watch Factory intends to enter the luxury watch market with Tissot.
    </p>
  </div>
