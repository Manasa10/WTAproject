...
<nav class="w3-sidebar w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;background-color: #f2e6ff" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <button class="button w3-hover-white" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Sign Up</button>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    <h1 class="w3-jumbo"><b>The Clothes Factory</b></h1>
  ...
  <?php
   $res = $conn->query("SELECT * FROM images where cid=2");
   $numr=$res->num_rows;
   if ($res->num_rows > 0) {
  ...
  <div class="w3-container" id="services" style="margin-top:75px">
    ...
    <hr style="width:50px;border:5px solid #f2e6ff" class="w3-round">
    <p>The Clothes Factory is a retail company that sells fitness apparel that is trendy, in demand, and competitively priced. 
        The store additionally emphasises high-growth products driven by current social trends, such as exercise/fitness, golf and fashion sports clothing.
    </p>
  </div>
